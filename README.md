...
```
    ...
    The product struct is a struct because i will never change the value of this, and therefore i dont need a class.
    The product struct can also contain a subProduct, which tells weather or not it is a collection of one of the other products.
